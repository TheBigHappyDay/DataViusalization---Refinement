...
class MyPanel(wx.Panel):
    def __init__(self, parent):
        print("---Unit Test Loading---")

        if file == None:
            print("Failed test (file allocation)")
        else:
            print("Passed Test (file allocaiton)")
        ...
        if self.nameArray != 63:
            print("Failed Test (nameArray length)")
        else:
            print("Passed Test (nameArray length)")
        ...
        if self.indexNum1 and self.indexNum2 == 0:
            print("Failed Test (indexing range 1)")
            print("Failed Test (indexing range 2)")
        else:
            print("Passed Test (index range 1)")
            print("Passed Test (index range 2)")

        print("Passed Test (init function)")
    ...
    def onCombo(self, event):
        ...
        print("Passed Test (onCombo function)")
    ...
    def onButton(self, event):
        ...
        if len(dataArray) or len(prefixArray) == 0:
            print("Failed Test (dataArray length)")
            print("Failed Test (prefixArray length)")
        else:
            print("Passed Test (dataArray length)")
            print("Passed Test (prefixArray length)")
    ...
    def dateFromEvent(self,event):
        ...
        print("Passed Test (date from function)")
    ...
    def dateToEvent(self,event):
        ...
        print("Passed Test (date to function)")

    def closeWindow(self,event):
        print("Passed Test (quit function)")
        quit()  
